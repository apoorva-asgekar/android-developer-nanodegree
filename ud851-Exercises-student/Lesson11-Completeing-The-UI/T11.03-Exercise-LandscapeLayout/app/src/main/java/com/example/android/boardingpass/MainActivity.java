...
import static com.example.android.boardingpass.R.id.textViewOriginAirport;
import static com.example.android.boardingpass.R.id.textViewTerminal;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void displayBoardingPassInfo(BoardingPassInfo info) {
        ...
        // TODOCOMPLETED (7) Use the flightInfor attribute in mBinding below to get the appropiate text Views
        ...
        // TODOCOMPLETED (8) Use the boardingInfo attribute in mBinding below to get the appropiate text Views
