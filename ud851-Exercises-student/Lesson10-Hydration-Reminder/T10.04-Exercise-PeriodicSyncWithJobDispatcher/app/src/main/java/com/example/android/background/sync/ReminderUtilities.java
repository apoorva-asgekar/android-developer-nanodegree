...
public class ReminderUtilities {
    // TODOCOMPLETED (15) Create three constants and one variable:
    ...
    // TODOCOMPLETED (16) Create a synchronized, public static method called scheduleChargingReminder that takes
    ...
    // Checkout https://github.com/firebase/firebase-jobdispatcher-android for an example
        // TODOCOMPLETED (17) If the job has already been initialized, return
        // TODOCOMPLETED (18) Create a new GooglePlayDriver
        // TODOCOMPLETED (19) Create a new FirebaseJobDispatcher with the driver
        // TODOCOMPLETED (20) Use FirebaseJobDispatcher's newJobBuilder method to build a job which:
        ...
        // TODOCOMPLETED (21) Use dispatcher's schedule method to schedule the job
        // TODOCOMPLETED (22) Set sInitialized to true to mark that we're done setting up the job
    public static void scheduleChargingReminder(Context context) {
        ...
        Log.v("ReminderUtilities", "Job scheduled");
        sInitialized = true;
    }
}
