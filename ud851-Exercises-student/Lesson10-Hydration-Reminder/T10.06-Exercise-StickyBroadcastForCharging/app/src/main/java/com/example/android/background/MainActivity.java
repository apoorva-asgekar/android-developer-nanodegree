...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onResume() {
        ...
        // TODOCOMPLETED (1) Check if you are on Android M or later, if so...
            // TODOCOMPLETED (2) Get a BatteryManager instance using getSystemService()
            // TODOCOMPLETED (3) Call isCharging on the battery manager and pass the result on to your show
            // charging method
        boolean isCharging;
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            Log.v("MainActivity", "In 23+ API");
            BatteryManager manager = (BatteryManager) getSystemService(BATTERY_SERVICE);
            isCharging = manager.isCharging();
        } else {
            Log.v("MainActivity", "In less than 23 API");
            // TODOCOMPLETED (4) If your user is not on M+, then...
            // TODOCOMPLETED (5) Create a new intent filter with the action ACTION_BATTERY_CHANGED. This is a
            // sticky broadcast that contains a lot of information about the battery state.
            IntentFilter filter = new IntentFilter(Intent.ACTION_BATTERY_CHANGED);
            // TODOCOMPLETED (6) Set a new Intent object equal to what is returned by registerReceiver, passing in null
            ...
            // TODOCOMPLETED (7) Get the integer extra BatteryManager.EXTRA_STATUS. Check if it matches
        ...
        // TODOCOMPLETED (8) Update the UI using your showCharging method
