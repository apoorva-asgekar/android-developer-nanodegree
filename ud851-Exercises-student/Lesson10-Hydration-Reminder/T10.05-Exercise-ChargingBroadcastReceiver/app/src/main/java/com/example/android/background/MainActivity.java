...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // TODOCOMPLETED (5) Create and instantiate a new instance variable for your ChargingBroadcastReceiver
        // and an IntentFilter
        ...
        // TODOCOMPLETED (6) Call the addAction method on your intent filter and add Intent.ACTION_POWER_CONNECTED
        // and Intent.ACTION_POWER_DISCONNECTED. This sets up an intent filter which will trigger
        // when the charging state changes.
    }

    // TODOCOMPLETED (7) Override onResume and setup your broadcast receiver. Do this by calling
    ...
    // TODOCOMPLETED (8) Override onPause and unregister your receiver using the unregisterReceiver method
    ...
    // TODOCOMPLETED (1) Create a new method called showCharging which takes a boolean. This method should
    ...
    // TODOCOMPLETED (2) Create an inner class called ChargingBroadcastReceiver that extends BroadcastReceiver
        // TODOCOMPLETED (3) Override onReceive to get the action from the intent and see if it matches the
        // Intent.ACTION_POWER_CONNECTED. If it matches, it's charging. If it doesn't match, it's not
        // charging.
        // TODOCOMPLETED (4) Update the UI using the showCharging method you wrote
