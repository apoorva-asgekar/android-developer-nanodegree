...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String SAVE_QUERY_URL_KEY = "query";

    // Create a static final key to store the search's raw JSON
    private static final String SAVE_RAW_JSON_KEY = "json";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState != null) {
            ...
            mSearchResultsTextView.setText(savedInstanceState.getString(SAVE_RAW_JSON_KEY));
        }
    }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString(SAVE_QUERY_URL_KEY, queryUrl);

        String rawJson = mSearchResultsTextView.getText().toString();
        outState.putString(SAVE_RAW_JSON_KEY, rawJson);
    }
    ...
    // Using the key for the raw JSON search results, put the search results into the outState Bundle
}