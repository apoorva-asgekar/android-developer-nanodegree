...
//  TODOCOMPLETED (1) Implement the delete method of the ContentProvider
    /**
...
//      TODOCOMPLETED (2) Only implement the functionality, given the proper URI, to delete ALL rows in the weather table

        if(rowsDeleted != 0) {
            getContext().getContentResolver().notifyChange(uri, null);
        }

//      TODOCOMPLETED (3) Return the number of rows deleted
        return rowsDeleted;
    }
