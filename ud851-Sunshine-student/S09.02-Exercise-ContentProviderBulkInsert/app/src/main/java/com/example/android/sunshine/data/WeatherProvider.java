...
//  TODOCOMPLETED (1) Implement the bulkInsert method
    /**
...
//          TODOCOMPLETED (2) Only perform our implementation of bulkInsert if the URI matches the CODE_WEATHER code

//              TODOCOMPLETED (3) Return the number of rows inserted from our implementation of bulkInsert

//          TODOCOMPLETED (4) If the URI does match match CODE_WEATHER, return the super implementation of bulkInsert
    }
